...
<div class="row">
<?php echo Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary pull-right m-r-20', 'name' => 'guest-invoice']) ?>
<div class="col-md-4">
