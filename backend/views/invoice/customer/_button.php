...
<ul class="dropdown-menu dropdown-menu-right">
	<?php if(empty($model->user)) : ?>
		<li><a class="add-customer" href="<?= Url::to(['invoice/fetch-user', 'id' => $model->id, 'userName' => null])?>">Add Existing Customer...</a></li>
		<li><a class="add-walkin" href="#">Add Walk-in...</a></li>
	<?php elseif($model->user->isCustomer()) : ?>
		<li><a class="add-customer" href="<?= Url::to(['invoice/fetch-user', 'id' => $model->id, 'userName' => null])?>">Change Customer...</a></li>
