          ...
          <div class="table-responsive">
              <table class="table-invoice-childtable" style="float:right; width:auto;">
                  <tr>
                      ...
                      <td><?= Yii::$app->formatter->asDecimal($model->totalDiscount); ?>
                      </td>
                  </tr>
                  <tr>
                      <td>SubTotal</td>
                      <td>
                            <?= Yii::$app->formatter->asDecimal($model->subTotal); ?>
                      </td>
                  </tr>
                  <tr>
                      <td>Tax</td>
                      <td>
                            <?= Yii::$app->formatter->asDecimal($model->tax); ?>
                      </td>
                  </tr>
                  <tr>
                      <td><strong>Total</strong></td>
                      <td><strong><?= Yii::$app->formatter->asDecimal($model->total); ?>
                          </strong>
                      </td>
                  </tr>
                  <tr>
                      <td>Paid</td>
                      <td>
                            <?= Yii::$app->formatter->asDecimal($model->invoicePaymentTotal); ?>
                      </td>
                  </tr>
                  <tr class="last-balance">
                      <td class="p-t-0"><strong>Balance</strong></td>
                      <td class="p-t-0"><strong><?= Yii::$app->formatter->asDecimal($model->balance); ?></strong></td>
                  </tr>
              </table>
          </div>
      </div>
