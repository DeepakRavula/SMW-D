...
echo Menu::widget([
    ...
    'items' => [
            ...
            'url' => ['/dashboard/index'],
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageDashboard'),
            ...
            'url' => ['/schedule/index'],
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageSchedule'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageEnrolments'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageStudents'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageCustomers'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageTeachers'),
        ...
        [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'managePrivateLessons'),
        ...
        [
            ...
            'icon' => '<i class="fa fa-music"></i>',
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageGroupLessons'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'managePfi'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageInvoices'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageReports'),
            'items' => [
                    [
                    'label' => Yii::t('backend', 'Birthdays'),
                    'icon' => '<i class="fa fa-birthday-cake" aria-hidden="true"></i>',
                    'url' => ['/report/student-birthday'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageBirthdays'),
                    ...
                    'icon' => '<i class="fa fa-dollar"></i>',
                    'url' => ['/report/payment'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'managePayments'),
                    ...
                    'icon' => '<i class="fa fa-dollar"></i>',
                    'url' => ['/report/royalty'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageRoyalty'),
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageTaxCollected'),
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageRoyaltyFreeItems'),
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageItemsByCustomer'),
                    ...
                    'icon' => '<i class="fa fa-cny"></i>',
                    'url' => ['/report/items'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageItemReport'),
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageItemCategoryReport'),
                ...
                [
                    ...
                    'icon' => '<i class="fa fa-cny"></i>',
                    'url' => ['/report/discount'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageDiscountReport'),
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageAllLocations'),
                ],
            ]
        ],
                [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageReleaseNotes'),
            'active' => (Yii::$app->controller->id === 'release-notes') ? true : false,
                ...
                [
                    ...
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageItems'),
                ],
                [
                    'label' => Yii::t('backend', 'Admin'),
                    'url' => '#',
                    'icon' => '<i class="fa fa-user"></i>',
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageAdminArea'),
                    'options' => ['class' => 'treeview'],
                    'items' => [
                            [
                    'label' => Yii::t('backend', 'Administrators'),
                    'icon' => '<i class="fa fa-user-secret"></i>',
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageAdmin'),
                ...
                [
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'managePrograms'),
                    ...
                    'url' => ['/permission'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'managePrivileges'),
                ...
                [
                    ...
                    'url' => ['/city/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageCities'),
                ],
                [
                    'label' => Yii::t('backend', 'Provinces'),
                    'icon' => '<i class="fa  fa-upload"></i>',
                    'url' => ['/province/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageProvinces'),
                ],
                [
                    'label' => Yii::t('backend', 'Countries'),
                    'icon' => '<i class="fa fa-globe"></i>',
                    'url' => ['/country/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageCountries'),
                ],
                [
                    'label' => Yii::t('backend', 'Taxes'),
                    'icon' => '<i class="fa  fa-cny"></i>',
                    'url' => ['/tax-code/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageTaxes'),
                ],
                [
                    'label' => Yii::t('backend', 'Color Code'),
                    'icon' => '<i class="fa fa-newspaper-o"></i>',
                    'url' => ['/calendar-event-color/edit'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageColorCode'),
                ],
                                [
                    'label' => Yii::t('backend', 'Item Category'),
                    'icon' => '<i class="fa fa-newspaper-o"></i>',
                    'url' => ['/item-category/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageItemCategory'),
                ],
                                [
                    'label' => Yii::t('backend', 'Reminder Notes'),
                    'icon' => '<i class="fa  fa-bell"></i>',
                    'url' => ['/reminder-note/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageReminderNotes'),
                ],
                [
                    'label' => Yii::t('backend', 'Blogs'),
                    'icon' => '<i class="fa fa-newspaper-o"></i>',
                    'url' => ['/blog/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageBlogs'),
                ],
                [
                    'label' => Yii::t('backend', 'Locations'),
                    'icon' => '<i class="fa  fa-map-marker"></i>',
                    'url' => ['/location/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageLocations'),
                ],
                [
                    'label' => Yii::t('backend', 'Holidays'),
                    'icon' => '<i class="fa fa-car"></i>',
                    'url' => ['/holiday/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageHolidays'),
                ],
                [
                    'label' => Yii::t('backend', 'Text Template'),
                    'icon' => '<i class="fa fa-envelope"></i>',
                    'url' => ['/text-template/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageEmailTemplate'),
                ],
            ],
        ],
        [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageSetupArea'),
            'options' => ['class' => 'treeview'],
            'items' => [
                    [
					...
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageStaff'),
                    ...
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageOwners'),
                    ...
                    'url' => ['/classroom/index'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageClassrooms'),
                ],
                    [
                    'label' => Yii::t('backend', 'Import'),
                    'icon' => '<i class="fa  fa-upload"></i>',
                    'url' => ['/user/import'],
					'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageImport'),
                ],
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'manageAccessControl'),
            'options' => ['class' => 'treeview'],
            'items' => [
