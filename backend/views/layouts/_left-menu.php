...
echo Menu::widget([
    ...
    'items' => [
            ...
            'url' => ['/schedule/index'],
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'viewSchedule'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listEnrolment'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listStudent'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listCustomer'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listTeacher'),
        ...
        [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listPrivateLesson'),
        ...
        [
            ...
            'icon' => '<i class="fa fa-music"></i>',
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listGroupLesson'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listPfiInvoice'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listInvoice'),
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'viewReport'),
            'items' => [
                    [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listReleaseNote'),
            'active' => (Yii::$app->controller->id === 'release-notes') ? true : false,
                ...
                [
                    ...
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listItem'),
                ],
                [
                    'label' => Yii::t('backend', 'Admin'),
                    'url' => '#',
                    'icon' => '<i class="fa fa-user"></i>',
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'viewAdmin'),
                    'options' => ['class' => 'treeview'],
                    'items' => [
                            [
        ...
        [
            ...
            'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'viewSetup'),
            'options' => ['class' => 'treeview'],
            'items' => [
                    [
                    ...
                    'visible' => Yii::$app->authManager->checkAccess(Yii::$app->user->id, 'listOwner'),
