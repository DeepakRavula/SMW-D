...
$form = ActiveForm::begin([
        'id' => 'financial-summary-search-form',
        'method' => 'get',
    ]);
...
<script>
    $(document).off('change', '#financial-summarysearch-daterange').on('change', '#financial-summarysearch-daterange', function() {
        $("#financial-summary-search-form").submit();
    });
</script>
