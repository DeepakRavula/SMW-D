...
<div class="form-group">
	<?= $form->field($course, 'startDate')->hiddenInput()->label(false); ?>
	<?= $form->field($course, 'programId')->hiddenInput()->label(false); ?>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.enrolment-edit', function(){
		...
		$('#course-programid').val(programId);
		$('#courseschedule-duration').val(duration);
