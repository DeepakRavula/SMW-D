...
var enrolment = {
    ...
    $(document).on('change', '#course-programid, #courseschedule-duration, #courseschedule-programrate, \n\
        #paymentfrequencyenrolmentdiscount-discount, #multienrolmentdiscount-discount', function(){
