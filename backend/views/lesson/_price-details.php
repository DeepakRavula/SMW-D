...
<dl class="dl-horizontal lesson-discount">
	...
	<dd><?= '$ ' . Yii::$app->formatter->asDecimal($model->programRate); ?></dd>
	<dt class="m-r-10">Gross Program Rate</dt>
    <dd><?= '$ ' . Yii::$app->formatter->asDecimal($model->grossPrice); ?></dd>
    <dt class="m-r-10">Net Program Rate</dt>
    <dd><?= '$ ' . Yii::$app->formatter->asDecimal($model->netPrice); ?></dd>
    <dt class="m-r-10">Unit Teacher Price</dt>
	<dd><?= '$ ' . Yii::$app->formatter->asDecimal($model->teacherRate); ?></dd>
	<dt class="m-r-10">Gross Teacher Rate</dt>
    <dd><?= '$ ' . Yii::$app->formatter->asDecimal($model->netCost); ?></dd>
</dl>
<?php LteBox::end()?>
<?php Pjax::end(); ?>