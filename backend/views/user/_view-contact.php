...
<div class="row-fluid p-20">
	...
	<div class="clearfix"></div>
	<div class="m-t-20">
		<?php echo Html::a('<i class="fa fa-pencil"></i> Edit Contact Information', ['update','UserSearch[role_name]' => $searchModel->role_name, 'id' => $model->id,'section' => 'contact'], ['class' => 'm-r-20']) ?>
	</div>
</div>
