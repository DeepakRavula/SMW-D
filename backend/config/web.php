...
$config = [
    ...
    'as globalAccess'=>[
        ...
        'rules'=>[
			...
			[
                'controllers'=>['schedule','student', 'release-notes', 'lesson', 'invoice','timeline-event','enrolment','teacher-availability','group-course','group-lesson','group-enrolment', 'payment'],
                'allow' => true,
                'roles' => ['staffmember'],
            ],
            [
