 ...
 * Create user form.
 */
class EnrolmentLineItemDiscount extends Model
{
    private $model;
    ...
    public function save()
    {
        if ($this->validate()) {
            ...
            $lineItemDiscount->valueType = InvoiceLineItemDiscount::VALUE_TYPE_DOLOR;
            $lineItemDiscount->type = InvoiceLineItemDiscount::TYPE_MULTIPLE_ENROLMENT;
