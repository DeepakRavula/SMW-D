...
class m180808_060947_add_soft_delete extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('lesson_discount', 'isDeleted', $this->boolean()->notNull());        
        ...
        // $this->addColumn('note', 'isDeleted', $this->boolean()->notNull());               
        ...
        $this->addColumn('user_location', 'isDeleted', $this->boolean()->notNull());        
        $this->addColumn('user_phone', 'isDeleted', $this->boolean()->notNull());        
        $this->addColumn('user_profile', 'isDeleted', $this->boolean()->notNull());        
    }
